...
export default function ProfileAnalyticsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setProfileViews(initialValues.profileViews);
    setCurrentProfileViewsValue("");
    setHoursSpentVolunteering(initialValues.hoursSpentVolunteering);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ProfileAnalytics(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProfileAnalyticsCreateForm")}
      {...rest}
    >
      <ArrayField
