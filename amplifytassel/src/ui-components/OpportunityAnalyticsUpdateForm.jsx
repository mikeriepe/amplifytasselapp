...
export default function OpportunityAnalyticsUpdateForm(props) {
  const {
    id: idProp,
    opportunityAnalytics: opportunityAnalyticsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = opportunityAnalyticsRecord
      ? { ...initialValues, ...opportunityAnalyticsRecord }
      : initialValues;
    setRecentApps(cleanValues.recentApps ?? []);
    setCurrentRecentAppsValue("");
    setApps(cleanValues.apps);
    setPopularUserTags(cleanValues.PopularUserTags ?? []);
    setCurrentPopularUserTagsValue("");
    setAppRate(cleanValues.appRate);
    setErrors({});
  };
  const [opportunityAnalyticsRecord, setOpportunityAnalyticsRecord] =
    React.useState(opportunityAnalyticsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(OpportunityAnalytics, idProp)
        : opportunityAnalyticsModelProp;
      setOpportunityAnalyticsRecord(record);
    };
    queryData();
  }, [idProp, opportunityAnalyticsModelProp]);
  React.useEffect(resetStateValues, [opportunityAnalyticsRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            OpportunityAnalytics.copyOf(
              opportunityAnalyticsRecord,
              (updated) => {
      ...
      {...getOverrideProps(overrides, "OpportunityAnalyticsUpdateForm")}
      {...rest}
    >
      <ArrayField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || opportunityAnalyticsModelProp)}
