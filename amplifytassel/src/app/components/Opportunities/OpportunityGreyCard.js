            ...
            if (type === "pending") {
              ...
              const req = await DataStore.query(Request, (r) =>
                ...
                .then(async (request) => {
                  ...
                  const profRole = await DataStore.query(ProfileRole, (p) =>
                    p.and((p) => [
                  ...
                  const oppProf = await DataStore.query(
                    OpportunityProfile,
                    (o) =>
                      o.and((o) => [
 ...
 * @return {JSX}
 */
export default function OpportunityGreyCard({
  type,
  opportunity,
  getPendingOpportunities,
  ...
  return (
    <>
      {opportunity && (
        <Card
          sx={{ width: '100%', borderRadius: 4, boxShadow: 3, backgroundColor: 'grey.200' }}
          className=""
        >
          <div
