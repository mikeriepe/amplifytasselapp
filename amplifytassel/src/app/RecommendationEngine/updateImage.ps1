docker build -t recommendation-engine:1.3 .
...
docker tag recommendation-engine:1.3 436713900294.dkr.ecr.us-west-1.amazonaws.com/recommendation-engine:latest
